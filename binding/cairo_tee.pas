//
// cairo-tee.h header binding for the Free Pascal Compiler aka FPC
//
...
function cairo_tee_surface_index(surface: Pcairo_surface_t; index: cuint): Pcairo_surface_t; cdecl; external LIB_CAIRO;
